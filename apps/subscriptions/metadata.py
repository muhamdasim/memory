...
ACTIVE_PRODUCTS = [
    ProductMetadata(stripe_id='prod_JqjjsfJlA8dBFX', name='Basic', features=['Up to 25 patients'], description='The Starter plan', is_default=True),
    ProductMetadata(stripe_id='prod_JqjhZTH411Gyl0', name='Premium', features=['Up to 50 patients'], description='The Premium plan', is_default=False),
    ProductMetadata(stripe_id='prod_Jqjg9Uk2T0yjVd', name='Standard', features=['Up to 75 patients'], description='The Standard plan', is_default=False)
]
