...
class ReactObjectLifecycleView(ObjectLifecycleView):
    template_name = 'pegasus/examples/objects/react_object_lifecycle.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        context.update({
            ...
            'url_base': reverse('pegasus_examples:react_object_lifecycle'),
        })
        return context
...
class VueObjectLifecycleView(ObjectLifecycleView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context.update({
            ...
            'url_base': reverse('pegasus_examples:vue_object_lifecycle'),
        })
        return context
